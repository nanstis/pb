<x-app-layout>
    ...
    <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[880px]">
            <div class="px-6 py-12 shadow sm:rounded-lg sm:px-12">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">You haven’t created a project yet. Get started by selecting a
                        template or
                        ...
                        <li class="flow-root">
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Another to-do system you’ll try but eventually
                                        give up
                                        on.</p>
                                </div>
                            </div>
                        ...
                        <li class="flow-root">
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Stay on top of your deadlines, or don’t — it’s
                                        up to
                                        you.</p>
                                </div>
                            </div>
